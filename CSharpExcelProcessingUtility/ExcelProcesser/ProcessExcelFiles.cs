...
namespace ExcelProcesser
{
    public partial class ProcessExcelFiles : Form
    {
        ...
        {
            //========Guidance=================//
            //Step1: Frequency Distribution Files Path: Pointing to files which are used to find out the class that was predicted max times during source execution(Always pointing to Source execution results)
            //C:\Users\faqeerrehman\MSU\OneDrive - Montana State University\Research\Clem\Candle_SoftmaxProbabilities\P1B2Tests\Results\Research1\Mutant1\SourceExecution\InstancePredictedClass
            ...
            //for the follow-up execution(MR0.xls).
            //C:\Users\faqeerrehman\MSU\OneDrive - Montana State University\Research\Clem\Candle_SoftmaxProbabilities\P1B2Tests\Results\Research1\Mutant1\MR0_Followup

            //Write location: the place where we want to have our newly generated files.
            //C:\Users\faqeerrehman\MSU\OneDrive - Montana State University\Research\Clem\Candle_SoftmaxProbabilities\P1B2Tests\Results\Research2_T_Test\Mutant1\MR0_Followup\InstancePredictedClass
            //=======End Guidance===========//


            int noOfSheets = 31;// 101;
            ...
            string toProcessFilePath = txtSingleFileReadLocation.Text;// @"C:\Users\faqeerrehman\MSU\CourseWork\ThirdSemester\STAT511\Project\Dataset\Mutant4\MR0_Followup\MR0Mutant4.xls";
            // Reading Excel Sheet
            ...
            int rowNoToBeProcessed = Convert.ToInt32(103);
            ...
            {
                // process explicitly added row numbers
                instancesToBeProcessed = new int[] {8,29,97,103,172,401,464,674,777,814};
            }

            foreach (int instanceNo in instancesToBeProcessed)
            {
                string writeFileLocation = txtSingleFileWriteLocation.Text + "\\" + instanceNo + ".xls";
                //string frequencyDistributionFilePath = @"C:\Users\faqeerrehman\MSU\OneDrive - Montana State University\Research\Clem\Candle_SoftmaxProbabilities\P1B2Tests\Results\Research1\Mutant1\SourceExecution\InstancePredictedClass\" + instanceNo + ".xls"; //C:\Users\faqeerrehman\MSU\OneDrive - Montana State University\Research\Clem\Candle_SoftmaxProbabilities\P1B2Tests\Results\Research1\Mutant1\SourceExecution\InstancePredictedClass\10.xls
                string frequencyDistributionFilePath = txtFrequencyDistributionFilesPath.Text + "\\" + instanceNo + ".xls"; //C:\Users\faqeerrehman\MSU\OneDrive - Montana State University\Research\Clem\Candle_SoftmaxProbabilities\P1B2Tests\Results\Research1\Mutant1\SourceExecution\InstancePredictedClass\10.xls
                ...
                for (int i = 2; i <= noOfSheets; i++)
                {
                    ...
                    //predictedClass = (string)(rangeOrigionalFile.Cells[rowToBeProcessed, 3] as Microsoft.Office.Interop.Excel.Range).Value2; // Origional File Predicted Class
                    probabilitiesInFile = (string)(rangeFile.Cells[rowToBeProcessed, 4] as Microsoft.Office.Interop.Excel.Range).Value2; // 4th column is 'Probabilities'
