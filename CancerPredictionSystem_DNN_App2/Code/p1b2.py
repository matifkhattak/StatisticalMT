...
def load_data(trainingRowsShuffle=False,testRowsShuffle=False, n_cols=None):
    ...
    #train_path = get_p1_file('C:/Users/faqeerrehman/MSU/Research/CancerPrediction/ScientificSWTesting/Data/Pilot1/TrainWithSmallFeatures.csv')
    #test_path = get_p1_file('C:/Users/faqeerrehman/MSU/Research/CancerPrediction/ScientificSWTesting/Data/Pilot1/TestWithSmallFeatures.csv')
    ...
    X_train = df_train.iloc[:, 2:].as_matrix() #Faqeer df_train.iloc[:, 2:].as_matrix()
    X_test = df_test.iloc[:, 2:].as_matrix() #Faqeer df_test.iloc[:, 2:].as_matrix()
