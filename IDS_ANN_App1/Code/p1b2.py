...
def load_data(trainingRowsShuffle=False,testRowsShuffle=False, n_cols=None):
    ...
    #train_path = 'C:/Users/faqeerrehman/MSU/CourseWork/SecondSemester/MachineLearning/CourseProject/IntrustionDetectionSystem/Pilot1/P1B2Tests/Data/TrainIDDS_week1Processed.csv'  # train.csv
    #test_path = 'C:/Users/faqeerrehman/MSU/CourseWork/SecondSemester/MachineLearning/CourseProject/IntrustionDetectionSystem/Pilot1/P1B2Tests/Data/TestIDDS_week1Processed.csv'  # test.csv
    train_path = '/Data/TrainIDS.csv'  # train.csv
    test_path = '/Data/TestIDS.csv'  # test.csv
