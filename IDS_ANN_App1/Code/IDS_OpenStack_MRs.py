...
class p1b2Tests(unittest.TestCase):
    ...
    def test_MRs(self):
        ...
        p1b2_baseline_keras2.recordSoftmaxProbabilities(X_train, y_train, X_test, y_test, False,"MR1.xls")
        ...
        p1b2_baseline_keras2.recordSoftmaxProbabilities(tempTrain, y_train, tempTest, y_test, False,"MR2.xls")
